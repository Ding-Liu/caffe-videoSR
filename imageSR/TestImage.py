# Super-resolution test for single image as input
caffe_root = '../'
import sys
...
if __name__ == '__main__':
    IMAGES = '/ws/ifp-06_1/dingliu2/data/SR/TestImage_x3_set14s1_ESPCN.mat'
    # IMAGES = '/ws/ifp-06_1/dingliu2/data/SR/TestImage_x2_set5s1_ESPCN-1.mat'  # for tanh activation models
