...
if __name__ == '__main__':
    ...
    # print 'Here are the arguments in run_caffe_finetune.py: ', args
    ...
    # initialize
    solver.net.copy_from('/home/dingliu2/Documents/caffe/videoSR/mdl/x4_sps50/espcn_iter_2600000.caffemodel')
